...
<html>
 ...
 <body>
    <div>
        <a href="index.php?op=new">Add new contact</a>
    </div>
    ...
    <tr>
    <td>
        <a href="index.php?op=show&id=<?php print $contact['id']; ?>"><?php print htmlentities($contact['name']); ?></a>
    </td>
    ...
    <td>
        <a href="index.php?op=delete&id=<?php print $contact['id'];?>">delete</a></td>
    </tr>
    <?php endforeach; ?>
    </tbody>
    </table>
